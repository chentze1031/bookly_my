...
final incomeCategories = <TxCategory>[
  ...
  TxCategory(id:'ar_collect',   icon:'💵', color:Color(0xFF059669), enLabel:'AR Collection',     zhLabel:'收款入账',   type:'income', mkEntries:(a)=>[JournalEntry(acc:'1020',dc:'Dr',val:a),JournalEntry(acc:'1100',dc:'Cr',val:a)]),
