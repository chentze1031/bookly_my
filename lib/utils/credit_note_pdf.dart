// ─── credit_note_pdf.dart ─────────────────────────────────────────────────────
// Malaysia Credit Note — adjusts a prior tax invoice (shows prices + SST)
// ─────────────────────────────────────────────────────────────────────────────
  ...
  pdf.addPage(pw.MultiPage(
    ...
    footer: (ctx) => pw.Container(
      ...
      child: pw.Row(
        ...
        children: [
          pw.Text('Generated by Bookly MY  ·  $cnDate', style: ts(7, c: _light)),
    ...
    build: (ctx) => [
      ...
      pw.Row(
        ...
        children: [
          ...
          pw.Column(
            ...
            children: [
              pw.Text('CREDIT NOTE', style: ts(20, bold: true, c: _red)),
              gap(10),
              metaRow('C/N No', cnNo,   ts(8, c: _grey), ts(8, bold: true)),
              metaRow('Date',   cnDate, ts(8, c: _grey), ts(8)),
              if (refInvNo != null && refInvNo.isNotEmpty)
                metaRow('Ref. Invoice', refInvNo, ts(8, c: _grey), ts(8, bold: true)),
            ],
          ),
        ],
      ),
        ...
        children: [
          pw.Expanded(
            child: pw.Column(
              crossAxisAlignment: pw.CrossAxisAlignment.start,
              children: [
                pw.Text('CREDIT TO', style: ts(7, c: _light, bold: true)),
                gap(4),
          ...
          if (reason != null && reason.isNotEmpty)
            pw.Expanded(
              child: pw.Column(
                crossAxisAlignment: pw.CrossAxisAlignment.end,
                children: [
                  pw.Text('REASON', style: ts(7, c: _light, bold: true)),
                  gap(4),
                  pw.Text(reason, style: ts(8.5, c: _grey),
      ...
      pw.Padding(
        ...
        child: pw.Row(children: [
          ...
          pw.SizedBox(width: 72,
              child: pw.Text('CREDIT',      style: ts(7.5, c: _grey, bold: true),
                  textAlign: pw.TextAlign.right)),
        ]),
      ),
      rule(),
      ...
      ...rows.asMap().entries.map((entry) {
        ...
        return pw.Container(
          ...
          child: pw.Row(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
            ...
            pw.SizedBox(width: 72,
                child: pw.Text('-${rm(net + sst)}', style: ts(8.5, bold: true, c: _red),
                    textAlign: pw.TextAlign.right)),
          ]),
        );
      }),
      ...
      pw.Align(
        ...
        child: pw.SizedBox(
          ...
          child: pw.Column(children: [
            ...
            gap(4),
            pw.Row(mainAxisAlignment: pw.MainAxisAlignment.spaceBetween, children: [
              pw.Text('TOTAL CREDIT', style: ts(10, bold: true)),
              pw.Text('-${rm(grand)}', style: ts(10, bold: true, c: _red)),
            ]),
          ]),
        ),
      ),
      ...
      gap(8),
      pw.Text(
        'This credit note adjusts the referenced tax invoice. '
