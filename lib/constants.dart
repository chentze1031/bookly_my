...
const accounts = <String, Account>{
  ...
  // Payroll payables (Phase 4 #C — accrued at payslip save, cleared on payment)
  '2110': Account('Net Salary Payable',       'Cr'),
  '2120': Account('EPF Payable',              'Cr'),
  '2130': Account('SOCSO Payable',            'Cr'),
  '2140': Account('EIS Payable',              'Cr'),
  '2150': Account('PCB/MTD Payable',          'Cr'),
  '2160': Account('Other Deductions Payable', 'Cr'),
  ...
  '5101': Account('EPF (Employer)',      'Dr'),
  '5102': Account('SOCSO (Employer)',    'Dr'),
  '5103': Account('EIS (Employer)',      'Dr'),
