...
class L10n {
  ...
  // Bill
  String get bill         => isZh ? '账单' : 'Bill';
  String get newBill2     => isZh ? '新增账单' : 'New Bill';
  String get supplier2    => isZh ? '供应商' : 'Supplier';
  String get expenseType  => isZh ? '费用类型' : 'Expense Type';
  String get payMode      => isZh ? '付款方式' : 'Payment';
  String get unpaid       => isZh ? '未付款' : 'Unpaid';
