...
final incomeCategories = <TxCategory>[
  ...
  // ── AR workflow (2-step) ─────────────────────────────────────────────────
  // Step 1: Issue invoice  → Dr 1100 AR        / Cr 4010 Revenue
  // Step 2: Collect cash   → Dr 1020 Bank      / Cr 1100 AR
  TxCategory(id:'ar_invoice',   icon:'📋', color:Color(0xFF0369A1), enLabel:'Invoice Issued',    zhLabel:'开发票',     type:'income', mkEntries:(a)=>[JournalEntry(acc:'1100',dc:'Dr',val:a),JournalEntry(acc:'4010',dc:'Cr',val:a)]),
  TxCategory(id:'ar_collect',   icon:'🧾', color:Color(0xFF0D9488), enLabel:'Invoice Collected', zhLabel:'收款入账',   type:'income', mkEntries:(a)=>[JournalEntry(acc:'1020',dc:'Dr',val:a),JournalEntry(acc:'1100',dc:'Cr',val:a)]),
];

final expenseCategories = <TxCategory>[
  // ── AP workflow (2-step) ─────────────────────────────────────────────────
  // Step 1: Receive bill   → Dr 5200 Expense   / Cr 2010 AP
  // Step 2: Pay supplier   → Dr 2010 AP        / Cr 1020 Bank
  TxCategory(id:'ap_bill',      icon:'📄', color:Color(0xFFDC2626), enLabel:'Bill Received',     zhLabel:'收到账单',   type:'expense', mkEntries:(a)=>[JournalEntry(acc:'5200',dc:'Dr',val:a),JournalEntry(acc:'2010',dc:'Cr',val:a)]),
  ...
  // ── Stock ─────────────────────────────────────────────────────────────────
  TxCategory(id:'inventory_in', icon:'📥', color:Color(0xFFB45309), enLabel:'Stock Purchase',    zhLabel:'进货',       type:'expense', mkEntries:(a)=>[JournalEntry(acc:'1200',dc:'Dr',val:a),JournalEntry(acc:'1020',dc:'Cr',val:a)]),
  // ── Direct cash expense ───────────────────────────────────────────────────
