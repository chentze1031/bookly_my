...
class TransactionsScreen extends StatefulWidget {
  ...
  const TransactionsScreen({super.key, required this.onEdit, required this.onUpgrade});
...
class _TxScreenState extends State<TransactionsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var visible = app.txs.where((tx) {
      ...
      if (_search.isNotEmpty && sub.hasAccess) {
      ...
      children: [
        ...
        Container(
          ...
          child: Column(children: [
            GestureDetector(
              onTap: sub.hasAccess ? null : widget.onUpgrade,
              child: TextField(
                readOnly: !sub.hasAccess,
                onChanged: (v) => setState(() => _search = v),
                decoration: InputDecoration(
                  hintText: sub.hasAccess ? t.search : '🔒 ${t.proLocked} — ${t.proUnlock}',
                  hintStyle: TextStyle(color: sub.hasAccess ? kMuted : kPro, fontSize: 14),
                  prefixIcon: const Icon(Icons.search, color: kMuted),
                  filled: true, fillColor: sub.hasAccess ? kBg : kProBg,
                  contentPadding: const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(12),
                    borderSide: BorderSide(color: sub.hasAccess ? kBorder : kProBd, width: 1.5)),
            ...
            SingleChildScrollView(
              ...
              child: Row(children: [
                ...
                if (sub.hasAccess && months.isNotEmpty) ...[
                        ...
                        child: Column(
                          children: txList.asMap().entries.map((e2) {
                            ...
                            return GestureDetector(
                              onTap: () => sub.hasAccess ? widget.onEdit(tx) : widget.onUpgrade(),
                              child: Container(
                                ...
                                child: Row(children: [
                                  ...
                                  Expanded(child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(children: [
                                        ...
                                        if (sub.hasAccess && tx.origCurrency != 'MYR')
                                  ...
                                  Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                                    ...
                                    Text(sub.hasAccess ? 'tap to edit' : '🔒 Pro',
                                      style: TextStyle(fontSize: 9,
                                        color: sub.hasAccess ? kMuted : kPro)),
                                  ]),
                                ]),
                              ),
                            );
...
class ReportsScreen extends StatefulWidget {
  final VoidCallback onUpgrade;
  const ReportsScreen({super.key, required this.onUpgrade});
        ...
        children: [
          ...
          Container(
            ...
            child: Row(children: [
              ...
              _ViewTab(
                label: sub.hasAccess ? t.sstRep : '🔒 ${t.sstRep}',
                value: 'sst', current: _view,
                onTap: () => sub.hasAccess ? setState(() => _view = 'sst') : widget.onUpgrade()),
            ]),
          ),
