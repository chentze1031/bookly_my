...
class _QuickBtn extends StatelessWidget {
  ...
  @override
  // NOTE: Do NOT return Expanded here — the caller wraps each button in
  // Expanded inside the Row. Returning Expanded here caused double-nesting
  // which broke uniform sizing across all 5 buttons.
    ...
    child: Stack(
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: bg,
            border: Border.all(color: bd, width: 1.8),
