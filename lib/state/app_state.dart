...
class AppState extends ChangeNotifier {
  ...
  // ── Invoice save (stores as a shared_preferences JSON list) ─────────────────
  Future<void> saveInvoice({
    ...
    // Replace if same invNo exists, otherwise prepend
  ...
  // ── Payroll save (stores as a shared_preferences JSON list) ──────────────────
